// Inspeciona resposta do LLM para o prompt de Clarification usando argumento de linha de comando
// Uso: node scripts/inspect-llm-clarification-msg.js "quero criar uma meta"
...
async function run() {
  try {
    ...
    const userMessage = process.argv[2] || 'quero criar uma meta';
    const systemPrompt = `${PROMPT}\n\nEstado atual da máquina: IDLE\nPayload atual: {}`;

    console.log('=== Mensagem de teste ===', userMessage);
