...
const SPEC: PromptSpec = {
  ...
  behaviour: {
    ...
    lines: [
      ...
      'Interprete: "sim", "ss", "s", "simm", "siiim", "quero", "pode ser", "pode", "isso", "claro", "bora", "marca" ou qualquer outra coisa que dê a entender que o usuário quer marcar a meta como concluída → confirmation_response com confirmed: true.',
      'Interprete: "não", "deixa", "deixa pra lá", "cancelar"  ou qualquer outra coisa que dê a entender que o usuário não quer marcar a meta como  → confirmation_response com confirmed: false.',
      '',
